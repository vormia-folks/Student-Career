            ...
            <form action="<?= $base_url; ?>/portal/student/application/update" method="post" accept-charset="utf-8" enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="row">
                    <div class="col-md-6 col-sm-12">
                        <?php $withdraw_url = "$base_url/portal/student/application/delete?id=" . $application_id; ?>
                        <a onclick="confirmAction('<?= $withdraw_url ?>')" class="btn btn-lg btn-danger w-100">
                            Widthdraw <i class="fas fa-trash"></i>
                        </a>
                    </div>
                    <div class="col-md-6 col-sm-12">

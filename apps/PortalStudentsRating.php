...
class PortalStudentsRating extends Controller
{
    ...
    public function index($message = null)
    {
        ...
        $sql .= " WHERE applications.application_student = $user_id AND applications.application_status = 3";
        // Order By
    ...
    public function edit($pageName, $inputTYPE = 'id', $inputID = null, $message = null, $layout = null)
    {
        ...
        if (!is_null($inputTYPE) || !is_null($inputID)) {
            ...
            //Notification
            $notify = $this->modal->notify->notify();
            $data['notify'] = $this->modal->notify->success('Application has been Rated');
...
/* End of file PortalStudentsRating.php */

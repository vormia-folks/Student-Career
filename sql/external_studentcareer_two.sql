...
--
-- Database: `external_studentcareer_two`
--
...
(1, 3, 1, 1, 10, 3, 'I have experience in Programming and Project Management', '2021-11-07 12:03:27', 1);
...
(1, '16j01acs012@anu.ac.ke', 1, 'student', '2021-11-01 16:19:55', 1),
(2, '19j01acs015@anu.ac.ke', 2, 'student', '2021-11-02 10:02:37', 1),
(3, '19s01acs03@anu.ac.ke', 3, 'student', '2021-11-05 13:13:11', 1),
(4, 'stamina@spu.ac.ke', 4, 'student', '2021-11-05 14:27:52', 1),
(5, '14s03adit005@anu.ac.ke', 5, 'student', '2021-11-05 14:33:54', 1),
(6, '17j01acs@anu.ac.ke', 6, 'student', '2021-11-05 14:36:23', 1),
(7, 'alphaguru@kemu.ac.ke', 7, 'student', '2021-11-05 14:50:41', 1),
(8, '20allan@spu.ac.ke', 8, 'student', '2021-11-07 08:19:55', 1),
...
(1, 'attachment', 0, 'Technical', '2021-11-07 09:30:24', 1),
(2, 'availability', 0, 'January - May', '2021-11-07 09:30:24', 1),
(3, 'major', 0, 'IT', '2021-11-07 09:30:50', 1),
(4, 'attachment', 0, 'Medical', '2021-11-07 09:30:24', 1),
(5, 'attachment', 0, 'Programming', '2021-11-07 09:30:24', 1),
(6, 'attachment', 0, 'Design', '2021-11-07 09:30:24', 1),
(7, 'attachment', 0, 'Support', '2021-11-07 09:30:24', 1),
(8, 'attachment', 0, 'Hospitality', '2021-11-07 09:30:24', 1),
(9, 'availability', 0, 'May - July', '2021-11-07 09:30:24', 1),
(10, 'availability', 0, 'July - September', '2021-11-07 09:30:24', 1),
(11, 'availability', 0, 'October - December', '2021-11-07 09:30:24', 1),
(12, 'major', 0, 'Business', '2021-11-07 09:30:50', 1),
(13, 'major', 0, 'MassComm', '2021-11-07 09:30:50', 1),
(14, 'major', 0, 'Public Relation', '2021-11-07 09:30:50', 1);
...
(1, 'Joshua', 'Minga', '16j01acs012@anu.ac.ke', '7085496611', 'fastemail47@gmail.com', 1, '7d38307ef52e802145060851c5225f7e02dd9581', '2021-11-01 16:19:55', 1),
(2, 'Fabian', 'Alex', '19j01acs015@anu.ac.ke', '', NULL, 1, '644850cb8939d255ed752957b7c4458c52900f75', '2021-11-02 10:02:37', 1),
(3, 'Ony\'ango ', 'Maina', '19s01acs03@anu.ac.ke', '', NULL, 1, '7d38307ef52e802145060851c5225f7e02dd9581', '2021-11-05 13:13:11', 1),
(4, 'Stamina', 'Rayoal', 'stamina@spu.ac.ke', '', NULL, 2, '7d38307ef52e802145060851c5225f7e02dd9581', '2021-11-05 14:27:52', 1),
(5, 'Dennis', 'Shiraho', '14s03adit005@anu.ac.ke', '', NULL, 1, '7d38307ef52e802145060851c5225f7e02dd9581', '2021-11-05 14:33:54', 1),
...
ALTER TABLE `applications`
  ...
  ADD KEY `application_internship` (`application_internship`),
  ADD KEY `application_student` (`application_student`);
...
ALTER TABLE `companies`
  ...
  ADD KEY `company_organization` (`company_organization`);
...
ALTER TABLE `curriculums`
  ...
  ADD KEY `curriculum_student` (`curriculum_student`),
  ADD KEY `curriculum_university` (`curriculum_university`),
  ADD KEY `curriculum_attachment` (`curriculum_attachment`),
  ADD KEY `curriculum_availability` (`curriculum_availability`),
  ADD KEY `curriculum_major` (`curriculum_major`);
...
ALTER TABLE `interships`
  ...
  ADD KEY `intership_organization` (`intership_organization`),
  ADD KEY `intership_university` (`intership_university`),
  ADD KEY `intership_attachment` (`intership_attachment`),
  ADD KEY `intership_availability` (`intership_availability`),
  ADD KEY `intership_major` (`intership_major`);
...
--
ALTER TABLE `applications`
  ADD CONSTRAINT `applications_ibfk_1` FOREIGN KEY (`application_internship`) REFERENCES `interships` (`intership_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `applications_ibfk_2` FOREIGN KEY (`application_student`) REFERENCES `students` (`student_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `companies`
--
ALTER TABLE `companies`
  ADD CONSTRAINT `companies_ibfk_1` FOREIGN KEY (`company_organization`) REFERENCES `organizations` (`organization_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `curriculums`
--
ALTER TABLE `curriculums`
  ADD CONSTRAINT `curriculums_ibfk_1` FOREIGN KEY (`curriculum_student`) REFERENCES `students` (`student_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `curriculums_ibfk_2` FOREIGN KEY (`curriculum_university`) REFERENCES `universities` (`university_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `curriculums_ibfk_3` FOREIGN KEY (`curriculum_attachment`) REFERENCES `options` (`option_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `curriculums_ibfk_4` FOREIGN KEY (`curriculum_availability`) REFERENCES `options` (`option_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `curriculums_ibfk_5` FOREIGN KEY (`curriculum_major`) REFERENCES `options` (`option_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `interships`
--
ALTER TABLE `interships`
  ADD CONSTRAINT `interships_ibfk_1` FOREIGN KEY (`intership_organization`) REFERENCES `organizations` (`organization_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `interships_ibfk_2` FOREIGN KEY (`intership_university`) REFERENCES `universities` (`university_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
ALTER TABLE `students`
  ADD CONSTRAINT `students_ibfk_1` FOREIGN KEY (`student_university`) REFERENCES `universities` (`university_id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;

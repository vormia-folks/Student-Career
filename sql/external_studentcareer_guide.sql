...
--
ALTER TABLE `universities`
  MODIFY `university_id` bigint(20) NOT NULL AUTO_INCREMENT;
...
ALTER TABLE `students`
  ...
  ADD FOREIGN KEY (`student_university`) REFERENCES `universities` (`university_id`)  ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `companies`
  ...
  ADD FOREIGN KEY (`company_organization`) REFERENCES `organizations` (`organization_id`)  ON DELETE CASCADE ON UPDATE CASCADE;
--
...
ALTER TABLE `curriculums`
  ...
  ADD FOREIGN KEY (`curriculum_student`) REFERENCES `students` (`student_id`)  ON DELETE CASCADE ON UPDATE CASCADE,
  ADD FOREIGN KEY (`curriculum_university`) REFERENCES `universities` (`university_id`)  ON DELETE CASCADE ON UPDATE CASCADE,
  ADD FOREIGN KEY (`curriculum_attachment`) REFERENCES `options` (`option_id`)  ON DELETE CASCADE ON UPDATE CASCADE,
  ADD FOREIGN KEY (`curriculum_availability`) REFERENCES `options` (`option_id`)  ON DELETE CASCADE ON UPDATE CASCADE,
  ADD FOREIGN KEY (`curriculum_major`) REFERENCES `options` (`option_id`)  ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `interships`
  ...
  ADD FOREIGN KEY (`intership_organization`) REFERENCES `organizations` (`organization_id`)  ON DELETE CASCADE ON UPDATE CASCADE,
  ADD FOREIGN KEY (`intership_university`) REFERENCES `universities` (`university_id`)  ON DELETE CASCADE ON UPDATE CASCADE,
  ADD FOREIGN KEY (`intership_attachment`) REFERENCES `options` (`option_id`)  ON DELETE CASCADE ON UPDATE CASCADE,
  ADD FOREIGN KEY (`intership_availability`) REFERENCES `options` (`option_id`)  ON DELETE CASCADE ON UPDATE CASCADE,
  ADD FOREIGN KEY (`intership_major`) REFERENCES `options` (`option_id`)  ON DELETE CASCADE ON UPDATE CASCADE;

--
-- AUTO_INCREMENT for table `interships`
--
ALTER TABLE `interships`
  MODIFY `intership_id` bigint(20) NOT NULL AUTO_INCREMENT;
...
ALTER TABLE `applications`
  ...
  ADD FOREIGN KEY (`application_internship`) REFERENCES `interships` (`intership_id`)  ON DELETE CASCADE ON UPDATE CASCADE,
  ADD FOREIGN KEY (`application_student`) REFERENCES `students` (`student_id`)  ON DELETE CASCADE ON UPDATE CASCADE;
...
(3, 'Ony\'ango ', 'Maina', '19s01acs03@anu.ac.ke', '', NULL, 1, '7d38307ef52e802145060851c5225f7e02dd9581', '2021-11-05 16:13:11', 1),
